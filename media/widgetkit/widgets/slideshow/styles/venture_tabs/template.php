...
<div id="slideshow-<?php echo $widget_id; ?>" class="wk-slideshow wk-slideshow-tabs-venture" data-widgetkit="slideshow" data-options='<?php echo json_encode($settings); ?>'>
	...
	<div class="nav-container <?php echo $nav; ?> clearfix">
		<ul class="nav">
			...
			<li class="tab-<?php echo $tabcount; $tabcount++; ?>">
