...
<div id="slideshow-<?php echo $widget_id; ?>" class="wk-slideshow wk-slideshow-infinite" data-widgetkit="slideshow" data-options='<?php echo json_encode($settings); ?>'>
	<div>
		<ul class="slides">
	...
	<?php echo ($settings['navigation'] && count($navigation)) ? '<div id="nav-wrapper"><ul class="nav">'.implode('', $navigation).'</ul></div>' : '';?>
</div>