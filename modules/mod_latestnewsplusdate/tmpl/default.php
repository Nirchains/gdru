	...
	if($show_date==1) 
	{
			switch($show_date_type) {
				case 1:
					...
					echo JHTML::_('date', htmlspecialchars( $item->publish_up ),JText::_('DATE_FORMAT_LC2'), $offset); // l, d F Y H:i
					echo "<br/></span>";
					break;
				case 2:
					echo "<span class=\"lnd_introdate\">";
					echo JHTML::_('date', htmlspecialchars( $item->publish_up ),JText::_('DATE_FORMAT_LC3'), $offset); // d F Y
					echo "<br/></span>";
					break;
				case 3:
					echo "<span class=\"lnd_introdate\">";
					echo JHTML::_('date', htmlspecialchars( $item->publish_up ),'H:i', $offset); // hour:minute
					echo "<br/></span>";
					break;
				case 4:
					echo "<span class=\"lnd_introdate\">";
					echo JHTML::_('date', htmlspecialchars( $item->publish_up ),'D, M jS Y', $offset); // Day name(short), Month(short) date th Year
					echo "<br/></span>";
					break;
				case 5:
					echo "<span class=\"lnd_introdate\">";
					echo JHTML::_('date', htmlspecialchars( $item->publish_up ),'l, F jS Y H:i', $offset); // Day name(short), Month(short) date th Year Hour:minute
					echo "<br/></span>";
					break;
				default:
					echo "<span class=\"lnd_introdate\">";
					echo JHTML::_('date', htmlspecialchars( $item->publish_up ),JText::_('DATE_FORMAT_LC1'), $offset); // l, d F Y
					echo "<br/></span>";
					break;
			}
	}
...
if($show_more_in) {
	...
	echo '<div class="lnd_more_ind">';
	   //echo "<span><strong>". JText::_( 'MOD_LATESTNEWSPLUSDATE_MORE_IN' ) ."</strong></span>";
		echo "<span><strong>M&aacute;s noticias en: </strong></span>";
	$cidbegin = 0;
