...
?>
<div class="div_lnd_intro animated fadeInLeft news-<?php echo $counting;?>">
	<div class="lnd_head">
    <?php
	...
	<div class='lnd_readmore span6'>
		<a href="<?php echo $item->link; ?>"><span class="sm">leer</span> +</a>
	</div>
	</div>
</div> <!-- end lnd_intro -->
...
<?php
	if ($counting%2!=0){
		...
		echo "<div class='lnd_espacio'></div>";
	}
	$counting++;
	if($counting == $numofintrotext) {
		if ($counting%2!=0){
			echo "</div>";
		}
		break;
