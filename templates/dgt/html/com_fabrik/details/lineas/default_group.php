...
foreach ($this->elements as $element) :
	//echo (json_encode($element)."<br><br><br>");
	...
	if ($element->id == "lineas___titulo_ro") {
		echo $this->loadTemplate('group_title');
	}
	elseif ($element->id == "lineas___imagen_linea_ro") {
		echo $this->loadTemplate('image');
	}
	elseif ($labels_above == 1)
	{
