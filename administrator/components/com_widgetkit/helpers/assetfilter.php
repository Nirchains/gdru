...
/*
	Class: AssetFilterWidgetkitHelper
		Asset filter helper class, to filter assets
*/
class AssetFilterWidgetkitHelper extends WidgetkitHelper {
	...
	*/
	public function create($filters = array()) {
		...
		// multiple filter
		$collection = new WidgetkitAssetFilterCollection();
...
/*
	Interface:  WidgetkitAssetFilterInterface
...
/*
	Class:  WidgetkitAssetFilterCollection
		Asset filter collection
*/
class WidgetkitAssetFilterCollection implements WidgetkitAssetFilterInterface, Iterator {
...
/*
	Class:  WidgetkitAssetFilterCSSImportResolver
		Stylesheet import resolver, replaces @imports with it's content
*/
class WidgetkitAssetFilterCSSImportResolver implements WidgetkitAssetFilterInterface {
	...
	*/
    public function filterLoad($asset) {
		...
		// is file asset?
		if (!is_a($asset, 'WidgetkitFileAsset')) {
			return;
		}
...
/*
	Class:  WidgetkitAssetFilterCSSRewriteURL
		Rewrite stylesheet urls, rewrites relative urls to absolute urls
*/
class WidgetkitAssetFilterCSSRewriteURL implements WidgetkitAssetFilterInterface {
...
/*
	Class:  WidgetkitAssetFilterCSSImageBase64
		Replace stylesheets image urls with base64 image strings
*/
class WidgetkitAssetFilterCSSImageBase64 implements WidgetkitAssetFilterInterface {
...
/*
	Class:  WidgetkitAssetFilterCSSCompressor
...
*/
class WidgetkitAssetFilterCSSCompressor implements WidgetkitAssetFilterInterface {
...
/*
	Class: WidgetkitAssetFilterJSCompressor
...
*/
class WidgetkitAssetFilterJSCompressor implements WidgetkitAssetFilterInterface {
