...
/*
	Class: HttpWidgetkitHelper
		HTTP helper class
*/    
class HttpWidgetkitHelper extends WidgetkitHelper {

	/* current transport class */
	var $transport;

	/* available transport classes */
	var $transports = array('WidgetkitHttpCurl', 'WidgetkitHttpStreams', 'WidgetkitHttpSocket');
...
/*
	Class: WidgetkitHttpCurl
		HTTP transport class using cURL
*/
class WidgetkitHttpCurl extends WidgetkitHttp {
...
/*
	Class: WidgetkitHttpStreams
		HTTP transport class using fopen and streams
*/
class WidgetkitHttpStreams extends WidgetkitHttp {
...
/*
	Class: WidgetkitHttpSocket
		HTTP transport class using fsockopen
*/
class WidgetkitHttpSocket extends WidgetkitHttp {
